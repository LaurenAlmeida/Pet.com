    ...
    <div class="carousel-inner">
      <div class="item active">
        ...
        <div class="carousel-caption">
          <h3>Adote!</h3>
          <a href="lista-adote.php">Você ganha um amigo!</a>
        </div>
      </div>
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          <h3>Ajude um pet</h3>
          <a href="insere-help.php">Saiba como proceder com animais que precisam da sua ajuda</a>
        </div>
      </div>
      ...
      <div class="item">
        ...
        <div class="carousel-caption">
          ...
          <a href="adocao.php">Cadastre animais para adoção</a>
        </div>
      </div>
